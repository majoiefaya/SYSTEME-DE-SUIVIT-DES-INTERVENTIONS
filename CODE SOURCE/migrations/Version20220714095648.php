 ...
 */
final class Version20220714095648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE action_infos (id INT AUTO_INCREMENT NOT NULL, creer_par VARCHAR(255) NOT NULL, creer_le DATE NOT NULL, modifier_par VARCHAR(255) DEFAULT NULL, modifier_le DATE DEFAULT NULL, enable TINYINT(1) NOT NULL, supprimer_par VARCHAR(255) DEFAULT NULL, supprimer_le DATE DEFAULT NULL, dtype VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE admin (id INT NOT NULL, rapport_id INT DEFAULT NULL, fonction VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_880E0D761DFBCC46 (rapport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, code VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE equipement (id INT NOT NULL, type_equipement_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, disponibilite VARCHAR(255) NOT NULL, nombre_utilisation INT NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_B8B4C6F3F082B869 (type_equipement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rapport (id INT NOT NULL, employe_id INT NOT NULL, contenu VARCHAR(255) DEFAULT NULL, date_envoi DATE DEFAULT NULL, fichier VARCHAR(255) DEFAULT NULL, sujet_rapport VARCHAR(255) NOT NULL, INDEX IDX_BE34A09C1B65292 (employe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE technicien (id INT NOT NULL, equipe_id INT DEFAULT NULL, chef_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_96282C4C6D861B89 (equipe_id), UNIQUE INDEX UNIQ_96282C4C150A48F1 (chef_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, age INT NOT NULL, sexe VARCHAR(255) NOT NULL, telephone INT NOT NULL, adresse VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
